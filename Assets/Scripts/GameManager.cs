...
public class GameManager : MonoBehaviour {
    ...
    public static Level[] gatelevels = { new NandLevel(), new NotLevel(), new AndLevel(), new OrLevel(), new NorLevel(), new XorLevel(), new XnorLevel(), new And3Level(), new Or3Level(), new Nand3Level(), new HadderLevel(), new AdderLevel(), new Adder2Level(), new SRLevel(), new SRGatedLevel(), new DGatedLevel(), new DLevel() };
